## Fourth plot constructions, file pre-downloaded and putted in a working directory

filename <- "household_power_consumption.txt"

## Read file do data frame with separation
FDF <- read.table(filename, header = TRUE, sep = ";", dec = ".")
...
plot(cleandf$ftime,cleandf$Voltage, ylab = "Voltage", xlab = "datetime", type = "l")
...
plot(cleandf$ftime,cleandf$Global_active_power, xlab = "datetime", type = "l")
dev.off()